...
public class ResLoanProducts {
	...
	public Boolean getWithEmpReference() {
	...
	public Boolean getWithCollateral() {
	...
	public String toString() {
		return "ResLoanProducts [dateTime=" + dateTime + ", lnId=" + lnID + ", bankId=" + bankID + ", bankName="
				+ bankName + ", loanType=" + loanType + ", loanName=" + loanName + ", currencyCode=" + currencyCode
				+ ", prodStatus=" + prodStatus + ", priority=" + priority + ", withEmpReference=" + withEmpReference
				+ ", withCollateral=" + withCollateral + ", withGracePeriod=" + withGracePeriod + ", auditorium="
				+ auditorium + ", comissionCash=" + comissionCash + ", comissionLoan=" + comissionLoan + ", minAge="
