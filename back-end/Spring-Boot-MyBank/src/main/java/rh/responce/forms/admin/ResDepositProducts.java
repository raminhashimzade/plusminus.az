...
public class ResDepositProducts {
	...
	public String toString() {
		return "ResDepositProducts [dateTime=" + dateTime + ", dpId=" + dpID + ", bankId=" + bankID + ", bankName="
				+ bankName + ", depositName=" + depositName + ", currencyCode=" + currencyCode + ", prodStatus="
				+ prodStatus + ", priority=" + priority + ", minAmount=" + minAmount + ", maxAmount=" + maxAmount
				+ ", minPeriod=" + minPeriod + ", maxPeriod=" + maxPeriod + ", minRate=" + minRate + ", maxRate="
				+ maxRate + ", liqType=" + liqType + ", withCapitalisation=" + withCapitalisation + ", withWithDraw="
				+ withWithDraw + ", withRefill=" + withRefill + ", withAutoProlongation=" + withAutoProlongation
				+ ", description=" + description + ", present=" + descriptionPresent + "]";
	}
