...
var ExchangeRateCalculatorComponent = /** @class */ (function () {
    function ExchangeRateCalculatorComponent(homeService) {
        this.homeService = homeService;
        this.currencyCodeIn = 'USD';
        this.currencyCodeOut = 'AZN';
    }
    ExchangeRateCalculatorComponent.prototype.ngOnInit = function () {
        this.getcurrBestRateList();
    };
    ExchangeRateCalculatorComponent.prototype.getcurrBestRateList = function () {
        var _this = this;
        this.homeService.getcurrBestRateList().subscribe(function (res) {
            _this.rates = res;
        });
    };
    ExchangeRateCalculatorComponent.prototype.calcInResult = function () {
        console.log('calc in');
        var inCurrencyCode = this.form.controls['currencyCodeIn'].value;
        var inRate = this.getRate('buy', inCurrencyCode);
        var outAmount = this.form.controls['amountOut'].value;
        var outCurrencyCode = this.form.controls['currencyCodeOut'].value;
        var outRate = this.getRate('sell', outCurrencyCode);
        var result = (outAmount * outRate / inRate).toFixed(2);
        this.form.controls['amountIn'].setValue(result);
    };
    ExchangeRateCalculatorComponent.prototype.calcOutResult = function () {
        console.log('calc out');
        var inAmount = this.form.controls['amountIn'].value;
        var inCurrencyCode = this.form.controls['currencyCodeIn'].value;
        var inRate = this.getRate('buy', inCurrencyCode);
        var outCurrencyCode = this.form.controls['currencyCodeOut'].value;
        var outRate = this.getRate('sell', outCurrencyCode);
        var result = (inAmount * inRate / outRate).toFixed(2);
        this.form.controls['amountOut'].setValue(result);
    };
    ExchangeRateCalculatorComponent.prototype.getRate = function (type, currencyCode) {
        if (currencyCode === 'AZN') {
            console.log('AZN');
            return 1;
        }
        return +this.rates.find(function (r) { return r.currencyCode === currencyCode; }).rates[0][type].rate;
    };
    ExchangeRateCalculatorComponent.ctorParameters = function () { return [
    ...
    return ExchangeRateCalculatorComponent;
}());
...
var ExchangeRateVisualizeComponent = /** @class */ (function () {
    function ExchangeRateVisualizeComponent(exchangeRateService, changeRef, sharedService, translateService, platformId) {
    ...
    ExchangeRateVisualizeComponent.prototype.ngOnInit = function () {
    };
    ExchangeRateVisualizeComponent.prototype.initChart = function () {
        google.charts.load('current', { 'packages': ['line'] });
        google.charts.setOnLoadCallback(this.drawChart.bind(this));
    };
    ExchangeRateVisualizeComponent.prototype.drawChart = function () {
        var _this = this;
    ...
    ExchangeRateVisualizeComponent.prototype.onSubmit = function () {
        var _this = this;
        this.data = null;
        this.loading = true;
        var newFormValue = Object(src_app_app_utils__WEBPACK_IMPORTED_MODULE_2__["parseMomentToString"])(Object(src_app_app_utils__WEBPACK_IMPORTED_MODULE_2__["deepClone"])(this.form.value));
        this.exchangeRateService.getcurrRateArchive(newFormValue)
            .subscribe(function (items) {
            if (!items) {
                return;
            }
            var dataSource = items.map(function (item) {
    ...
    ExchangeRateVisualizeComponent.ctorParameters = function () { return [
    ...
    return ExchangeRateVisualizeComponent;
}());
...
var ExchangeRatesComponent = /** @class */ (function () {
    function ExchangeRatesComponent(exchangeRatesService, changeRef, titlseService, translateService, platformId) {
    ...
    ExchangeRatesComponent.prototype.ngOnInit = function () {
        this.getBestRates();
        this.getAllRates();
    };
    ExchangeRatesComponent.prototype.getBestRates = function () {
        var _this = this;
        this.exchangeRatesService.getcurrBestRateList().subscribe(function (res) {
            _this.favorableCurrencies = res;
            _this.changeRef.detectChanges();
        });
    };
    ExchangeRatesComponent.prototype.onSort = function (rate, type, sortBy) {
        try {
            this.sortState = { rate: rate, type: type, sortBy: sortBy };
            var sortedCurrencies = void 0;
            if (sortBy === 'desc') {
                sortedCurrencies = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.allCurrencies).sort(function (a, b) {
            ...
            this.allCurrencies = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](sortedCurrencies);
        }
        catch (er) {
            console.log(er);
        }
    ...
    ExchangeRatesComponent.prototype.isActiveSort = function (rate, type, sortBy) {
        return JSON.stringify(this.sortState) === JSON.stringify({ rate: rate, type: type, sortBy: sortBy });
    };
    ExchangeRatesComponent.prototype.getAllRates = function () {
        var _this = this;
        this.loading = true;
        this.exchangeRatesService.getCurrRateList()
            ...
            _this.allCurrencies = res;
            _this.filteredCurrencies = res;
            if (_this.allCurrencies && _this.allCurrencies[0]
                && _this.allCurrencies[0].bankCurrRate
                && _this.allCurrencies[0].bankCurrRate.CASH
                && _this.allCurrencies[0].bankCurrRate.CASH[0]) {
                _this.buildRateList();
                _this.changeRef.detectChanges();
            }
        });
    };
    ExchangeRatesComponent.prototype.buildRateList = function () {
        var rateList = Object.keys(this.allCurrencies[0].bankCurrRate.CASH[0]);
        // this.rateList = rateList ? rateList.filter(rate => (rate !== 'OIL') && (rate !== 'GOLD')) : [];
        this.rateList = ['USD', 'EUR', 'RUB', 'TRY'];
        this.changeRef.detectChanges();
    };
    ExchangeRatesComponent.prototype.onNextRateScroll = function () {
        try {
            if (!Object(_angular_common__WEBPACK_IMPORTED_MODULE_6__["isPlatformBrowser"])(this.platformId)) {
                return;
            }
            var el = document.getElementsByClassName('exchange-rates-full__table')[0];
            el.scrollBy({
                left: 200,
                behavior: 'smooth'
            });
    ...
    ExchangeRatesComponent.prototype.filterBanks = function (str) {
        if (!str) {
            this.filteredCurrencies = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.allCurrencies);
        }
        else {
            this.filteredCurrencies = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.allCurrencies).filter(function (cur) { return cur.bankName.toLowerCase().includes(str); });
        }
    };
    ExchangeRatesComponent.ctorParameters = function () { return [
...
var ExchangeRatesModule = /** @class */ (function () {
    function ExchangeRatesModule() {
    }
...
var ExchangeRatesRoutingModule = /** @class */ (function () {
    function ExchangeRatesRoutingModule() {
    }
    ...
    return ExchangeRatesRoutingModule;
}());
...
var ExchangeRatesService = /** @class */ (function () {
    function ExchangeRatesService(http, authService) {
        this.http = http;
        this.authService = authService;
    }
    ExchangeRatesService.prototype.getcurrBestRateList = function () {
        return this.http.post('mybank/currBestRateList', {
            token: this.authService.getToken(),
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res && res.data; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (er) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null); }));
    };
    ExchangeRatesService.prototype.getCurrRateList = function () {
        return this.http.post('mybank/currRateList', {
            token: this.authService.getToken(),
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res && res.data; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (er) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null); }));
    };
    ExchangeRatesService.prototype.getcurrRateArchive = function (formValue) {
        return this.http.post('mybank/currRateArchive', tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ token: this.authService.getToken() }, formValue)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res && res.data; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (er) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null); }));
    };
...
//# sourceMappingURL=home-exchange-rates-exchange-rates-module-es5.js.map