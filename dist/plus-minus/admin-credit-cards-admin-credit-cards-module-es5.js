...
var AddOrEditCreditCardComponent = /** @class */ (function () {
    function AddOrEditCreditCardComponent(data, dialogRef, sharedAdminService, productService, adminService, translateService) {
        this.data = data;
    ...
    AddOrEditCreditCardComponent.prototype.ngOnInit = function () {
    ...
    AddOrEditCreditCardComponent.prototype.onUpdate = function () {
        var _this = this;
        if (!this.form.valid) {
            return;
        }
        ...
        this.productService.crudProduct(_models_crud_command_type_enum__WEBPACK_IMPORTED_MODULE_8__["CrudCommandType"].UPDATE, this.creditCard)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["finalize"])(function () { return _this.loading = false; }))
    ...
    AddOrEditCreditCardComponent.prototype.onAdd = function () {
        var _this = this;
        if (!this.form.valid) {
            return;
        }
    ...
    AddOrEditCreditCardComponent.prototype.onAddSuccess = function (res) {
        this.adminService
            .createNotification("[ LOAN ] " + this.translateService.instant('~addSuccess'), 'OK', 'success');
        this.dialogRef.close(res);
    };
    AddOrEditCreditCardComponent.prototype.onUpdateSuccess = function (res) {
        this.adminService
            .createNotification("[ LOAN ] " + this.translateService.instant('~updateSuccess'), 'OK', 'success');
        this.dialogRef.close(res);
    };
    AddOrEditCreditCardComponent.ctorParameters = function () { return [
    ...
    return AddOrEditCreditCardComponent;
}());
...
var AdminCreditCardService = /** @class */ (function () {
    function AdminCreditCardService(http, adminPanelService) {
        this.http = http;
        this.adminPanelService = adminPanelService;
    }
    AdminCreditCardService.prototype.crudProduct = function (commandType, product) {
        if (product === void 0) { product = {}; }
        if (product && product.cardImage) {
            product.cardImage = product.cardImage.split(',')[1];
        }
        return this.http.post('mybank/crud/cardCreditProduct', tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ adminToken: this.adminPanelService.token, commandType: commandType }, product)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res && res.data; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (er) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null); }));
    };
    AdminCreditCardService.ctorParameters = function () { return [
...
var AdminCreditCardsComponent = /** @class */ (function () {
    function AdminCreditCardsComponent(productService, translateService, dialog, adminService, changeRef) {
        this.productService = productService;
        this.translateService = translateService;
        this.dialog = dialog;
        this.adminService = adminService;
    ...
    AdminCreditCardsComponent.prototype.ngOnInit = function () {
        this.getData();
    };
    AdminCreditCardsComponent.prototype.applyFilter = function (column, filterValue) {
        console.log(column);
    ...
    AdminCreditCardsComponent.prototype.applyMultiLangFilter = function (column, filterValue) {
        this.dataSource.filterPredicate =
    ...
    AdminCreditCardsComponent.prototype.isMultiLang = function (column) {
        if (column === 'editer') {
            return 'editer';
        }
        return (column === 'cardName') ? 'multilang' : 'standard';
    };
    AdminCreditCardsComponent.prototype.getData = function () {
        var _this = this;
        ...
        this.productService.crudProduct(_models_crud_command_type_enum__WEBPACK_IMPORTED_MODULE_9__["CrudCommandType"].SELECT, {})
            ...
            columns.push('editer');
            _this.allColumns = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](columns).filter(function (column) { return (column !== 'description') && (column !== 'descriptionPD') && (column !== 'descriptionDOC') && (column !== 'cdId'); });
            _this.allColumns.unshift('cdId');
    ...
    AdminCreditCardsComponent.prototype.getFilterValue = function (column) {
        if (!(this.dataFilterState && this.dataFilterState.column === column)) {
            return;
        }
        return this.dataFilterState.filterValue;
    };
    AdminCreditCardsComponent.prototype.onEdit = function (item) {
        var _this = this;
        var ref = this.dialog.open(_add_or_edit_credit_card_add_or_edit_credit_card_component__WEBPACK_IMPORTED_MODULE_12__["AddOrEditCreditCardComponent"], tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ data: {
                item: item
    ...
    AdminCreditCardsComponent.prototype.onAdd = function () {
        var _this = this;
        var ref = this.dialog.open(_add_or_edit_credit_card_add_or_edit_credit_card_component__WEBPACK_IMPORTED_MODULE_12__["AddOrEditCreditCardComponent"], tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ data: {} }, _admin_panel_utils__WEBPACK_IMPORTED_MODULE_10__["TableDialogConfig"]));
        ref.afterClosed().subscribe(function (res) { return res && _this.getData(); });
    };
    AdminCreditCardsComponent.prototype.onDelete = function (element) {
        var _this = this;
        var ref = this.dialog.open(_shared_components_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_11__["ConfirmDialogComponent"], {
            data: {
        ...
        ref.afterClosed().subscribe(function (res) {
            if (res) {
                _this.productService.crudProduct(_models_crud_command_type_enum__WEBPACK_IMPORTED_MODULE_9__["CrudCommandType"].DELETE, element)
                    .subscribe(function (res) {
                    if (res) {
                        _this.adminService
                            .createNotification("[ CREDIT CARD ] " + _this.translateService.instant('~deleteSuccess'), 'OK', 'success');
                        _this.getData();
                    }
                });
            }
    ...
    AdminCreditCardsComponent.prototype.showAllColumns = function () {
        this.visibleColumns = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.allColumns);
    };
    AdminCreditCardsComponent.prototype.hideAllColumns = function () {
        this.visibleColumns = [];
    };
    AdminCreditCardsComponent.prototype.onToggleColumns = function (columns) {
        this.visibleColumns = columns;
    };
    AdminCreditCardsComponent.ctorParameters = function () { return [
    ...
    return AdminCreditCardsComponent;
}());
...
var AdminCreditCardsModule = /** @class */ (function () {
    function AdminCreditCardsModule() {
    }
...
var AdminCreditCardsRoutingModule = /** @class */ (function () {
    function AdminCreditCardsRoutingModule() {
    }
    ...
    return AdminCreditCardsRoutingModule;
}());
...
//# sourceMappingURL=admin-credit-cards-admin-credit-cards-module-es5.js.map