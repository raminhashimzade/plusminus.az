...
var DebitCardCompareComponent = /** @class */ (function () {
    function DebitCardCompareComponent(productService, router, route, dialog, translateService, platformId) {
    ...
    DebitCardCompareComponent.prototype.resize = function () { this.buildView(); };
    DebitCardCompareComponent.prototype.ngOnInit = function () {
    ...
    DebitCardCompareComponent.prototype.getPreviewProduct = function (id) {
        var _this = this;
        this.loading = true;
    ...
    DebitCardCompareComponent.prototype.getCompareProductList = function () {
        var _this = this;
        this.loading = true;
    ...
    DebitCardCompareComponent.prototype.setVisibleProducts = function () {
        this.setItemsPerTable();
        this.visibleProducts = this.products.slice(this.pageIndex, this.pageIndex + this.itemsPerTable);
    };
    DebitCardCompareComponent.prototype.onPrevProduct = function () {
    ...
    DebitCardCompareComponent.prototype.onNextProduct = function () {
    ...
    DebitCardCompareComponent.prototype.hasPrevProduct = function () {
        return this.pageIndex !== 0;
    };
    DebitCardCompareComponent.prototype.hasNextProduct = function () {
        if (!this.products) {
            return;
        }
        return !(this.pageIndex + this.itemsPerTable >= this.products.length);
    };
    DebitCardCompareComponent.prototype.setItemsPerTable = function () {
    ...
    DebitCardCompareComponent.prototype.buildView = function () {
    ...
    DebitCardCompareComponent.prototype.openDocumentDialog = function (documentData, type) {
    ...
    DebitCardCompareComponent.ctorParameters = function () { return [
    ...
    return DebitCardCompareComponent;
}());
...
var DebitCardLoaderComponent = /** @class */ (function () {
    function DebitCardLoaderComponent() {
        this.items = new Array(5);
    }
    DebitCardLoaderComponent.prototype.ngOnInit = function () {
    };
    ...
    return DebitCardLoaderComponent;
}());
...
var DebitCardsFilterComponent = /** @class */ (function () {
    function DebitCardsFilterComponent(translateService, sharedService, router, route, breakPointObserver, productService) {
        this.translateService = translateService;
    ...
    DebitCardsFilterComponent.prototype.resize = function () { this.updateForLayoutChange(); };
    DebitCardsFilterComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () { return _this.listenToformChange(); }, 10);
        this.isMdSize = this.breakPointObserver.isMatched('(max-width: 992px)');
    };
    Object.defineProperty(DebitCardsFilterComponent.prototype, "isContainerFluid", {
        get: function () {
    ...
    DebitCardsFilterComponent.prototype.updateForLayoutChange = function () {
        this.isMdSize = this.breakPointObserver.isMatched('(max-width: 992px)');
    };
    DebitCardsFilterComponent.prototype.ngOnDestroy = function () {
        this._onDestroy$.next();
    };
    DebitCardsFilterComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        setTimeout(function () { return _this.listenToRouterParams(); });
    };
    DebitCardsFilterComponent.prototype.listenToRouterParams = function () {
        var _this = this;
        this.route.params
    ...
    DebitCardsFilterComponent.prototype.listenToformChange = function () {
        var _this = this;
    ...
    DebitCardsFilterComponent.prototype.onSubmit = function () {
        this.seachProducts(true);
    };
    DebitCardsFilterComponent.prototype.seachProducts = function (scrollIntoView) {
        var _this = this;
        ...
        this.router.navigate(['/home/debit-cards', tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, filterForm)]);
    };
    DebitCardsFilterComponent.ctorParameters = function () { return [
        { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateService"] },
    ...
    return DebitCardsFilterComponent;
}());
...
var DebitCardsTableComponent = /** @class */ (function () {
    function DebitCardsTableComponent(route, productService, changeRef, breakpointObserver, sharedService, dialog, translateService, titleService) {
        this.route = route;
        this.productService = productService;
    ...
    DebitCardsTableComponent.prototype.resize = function () { this.updateForLayoutChange(); };
    DebitCardsTableComponent.prototype.ngOnInit = function () {
        this.listenToRouterParams();
        this.changeRef.detectChanges();
    };
    Object.defineProperty(DebitCardsTableComponent.prototype, "isLGSize", {
        get: function () {
    ...
    Object.defineProperty(DebitCardsTableComponent.prototype, "showDocuments", {
        get: function () {
    ...
    DebitCardsTableComponent.prototype.onExpandGroup = function (groupId) {
    ...
    DebitCardsTableComponent.prototype.ngOnDestroy = function () {
        this._onDestroy$.next();
    };
    DebitCardsTableComponent.prototype.updateForLayoutChange = function () {
        this.changeRef.detectChanges();
    };
    DebitCardsTableComponent.prototype.listenToRouterParams = function () {
        var _this = this;
        this.route.params
            ...
            _this.getListDebitCardGroups(formValue, scrollIntoView);
        });
        this.changeRef.detectChanges();
    };
    DebitCardsTableComponent.prototype.getListDebitCardGroups = function (data, scrollIntoView) {
        var _this = this;
        ...
        this.productService.getListGCardDebetProduct(data)
            ...
            .subscribe(function (res) {
            _this.productGroups = res;
            _this.filteredGroupProducts = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.productGroups);
            //   if (scrollIntoView) {switchToView('#products-table-filter') }
        });
    };
    DebitCardsTableComponent.prototype.onAddProductToCompare = function (product) {
        this.productService.addProductToCompare(product);
        this.changeRef.detectChanges();
    };
    DebitCardsTableComponent.prototype.canAddProductToCompare = function (id) {
        return this.productService.getSavedCompareProductList()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["map"])(function (products) { return !!products.find(function (l) { return l.cdID === id; }); }));
    };
    DebitCardsTableComponent.prototype.onSortChange = function (sortChange) {
        this.sortState = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, sortChange);
        this.filteredGroupProducts = this.sharedService.sortTableWithRowGroups(this.sortState, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.productGroups));
        this.changeRef.detectChanges();
    };
    DebitCardsTableComponent.prototype.applyFilter = function (filterValue) {
        this.filteredGroupProducts = this.sharedService.
            filterTableWithRowGroups(filterValue, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.productGroups), ['bankName']);
        this.changeRef.detectChanges();
    };
    DebitCardsTableComponent.ctorParameters = function () { return [
    ...
    return DebitCardsTableComponent;
}());
...
var DebitCardsComponent = /** @class */ (function () {
    function DebitCardsComponent() {
    }
    DebitCardsComponent.prototype.ngOnInit = function () {
    };
...
var DebitCardsModule = /** @class */ (function () {
    function DebitCardsModule() {
    }
...
var DebitCardsRoutingModule = /** @class */ (function () {
    function DebitCardsRoutingModule() {
    }
    ...
    return DebitCardsRoutingModule;
}());
...
var DebitCardFilterForm = /** @class */ (function () {
    function DebitCardFilterForm() {
...
//# sourceMappingURL=home-debit-cards-debit-cards-module-es5.js.map