...
var MortgageFilterComponent = /** @class */ (function () {
    function MortgageFilterComponent(translateService, loanService, sharedService, router, route, breakPointObserver) {
    ...
    MortgageFilterComponent.prototype.resize = function () { this.updateForLayoutChange(); };
    MortgageFilterComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () { return _this.listenToformChange(); }, 20);
        this.isMdSize = this.breakPointObserver.isMatched('(max-width: 992px)');
    };
    Object.defineProperty(MortgageFilterComponent.prototype, "isContainerFluid", {
        get: function () {
    ...
    MortgageFilterComponent.prototype.updateForLayoutChange = function () {
        this.isMdSize = this.breakPointObserver.isMatched('(max-width: 992px)');
    };
    MortgageFilterComponent.prototype.ngOnDestroy = function () {
        this._onDestroy$.next();
    };
    MortgageFilterComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        setTimeout(function () { return _this.listenToRouterParams(); }, 10);
    };
    MortgageFilterComponent.prototype.listenToRouterParams = function () {
        var _this = this;
        this.route.params
    ...
    MortgageFilterComponent.prototype.listenToformChange = function () {
        var _this = this;
    ...
    MortgageFilterComponent.prototype.onSubmit = function () {
        this.searchLoans();
    };
    MortgageFilterComponent.prototype.searchLoans = function () {
        var _this = this;
        if (!this.form.valid) {
            return;
        }
        ...
        Object.keys(this.form.value).forEach(function (key) {
            if (_this.form.controls[key].value) {
                filterForm[key] = _this.form.controls[key].value;
            }
            ;
        });
        this.router.navigate(['/home/mortgage', tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, filterForm)]);
    };
    MortgageFilterComponent.prototype.getErrorMessage = function (controlKey) {
        return this.form.controls[controlKey].hasError('required') ?
            this.translateService.instant('~requiredField') : '';
    };
    MortgageFilterComponent.prototype.onSlideMove = function (change) {
        this.slideValue = change.value;
        // this.mo.depositAmount = this.slideValue;
    };
    MortgageFilterComponent.ctorParameters = function () { return [
    ...
    return MortgageFilterComponent;
}());
...
module.exports = ":host {\n  display: block;\n}\n\n.sort-field {\n  font-size: 13px;\n}\n\n.cards {\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n}\n\n.card {\n  min-height: 130px;\n  padding: 20px;\n  margin: 8px 0 0;\n  width: 100%;\n  max-width: 350px;\n}\n\n.card .card__header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  border-bottom: 1px solid #dddede;\n  padding-bottom: 10px;\n}\n\n.card .card__header .card__header__bank img {\n  max-width: 90px;\n  max-height: 30px;\n}\n\n.card .card__content .card__content__row {\n  display: flex;\n  justify-content: space-between;\n  border-bottom: 1px solid #dddede;\n  padding: 10px 0;\n}\n\n.card .card__content .card__content__row .card__content__row__left {\n  font-size: 12px;\n  max-width: 200px;\n}\n\n.card .card__content .card__content__row .card__content__row__right {\n  max-width: 195px;\n  font-size: 12px;\n  font-weight: bold;\n}\n\n.card .card__footer {\n  padding-top: 10px;\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n}\n\n.card .card__footer a {\n  width: 45%;\n  font-size: 14px;\n}\n\n.expand {\n  font-size: 12px;\n  display: flex;\n  color: var(--secondary-default);\n  margin-top: 5px;\n  cursor: pointer;\n}\n\n.expand .expand__title {\n  margin-right: 3px;\n  font-family: \"Montserrat-Thin\";\n}\n\n.expand .expand__icon {\n  transition: transform 300ms ease-in-out;\n}\n\n.expand.--top .expand__icon {\n  transform: rotateZ(-180deg);\n}\n\n.expand-icon {\n  padding: 0.75rem;\n  padding-top: 0.9375rem;\n  cursor: pointer;\n  font-size: 1.2rem;\n  color: var(--primary-default);\n  transition: transform 300ms ease-in-out;\n}\n\n.expand-icon.--top {\n  transform: rotateZ(-180deg);\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MortgageCardsComponent = /** @class */ (function () {
    function MortgageCardsComponent() {
        this.sortChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    MortgageCardsComponent.prototype.ngOnInit = function () {
    };
    MortgageCardsComponent.prototype.onExpandGroup = function (groupId) {
    ...
    MortgageCardsComponent.prototype.onSort = function (sortKey) {
...
var MortgageTableComponent = /** @class */ (function () {
    function MortgageTableComponent(route, loanService, changeRef, breakpointObserver, sharedService, dialog, translateService, titleService) {
        this.route = route;
        this.loanService = loanService;
    ...
    MortgageTableComponent.prototype.resize = function () { this.updateForLayoutChange(); };
    MortgageTableComponent.prototype.ngOnInit = function () {
        this.listenToRouterParams();
        this.changeRef.detectChanges();
    };
    Object.defineProperty(MortgageTableComponent.prototype, "isLGSize", {
        get: function () {
    ...
    Object.defineProperty(MortgageTableComponent.prototype, "showDocuments", {
        get: function () {
    ...
    MortgageTableComponent.prototype.onExpandGroup = function (groupId) {
        if (this.expandedGroupId === groupId) {
            this.expandedGroupId = undefined;
            return;
        }
    ...
    MortgageTableComponent.prototype.ngOnDestroy = function () {
        this._onDestroy$.next();
    };
    MortgageTableComponent.prototype.updateForLayoutChange = function () {
        this.changeRef.detectChanges();
    };
    MortgageTableComponent.prototype.listenToRouterParams = function () {
        var _this = this;
        this.route.params
    ...
    MortgageTableComponent.prototype.getListloanGroupProducts = function (data) {
        var _this = this;
    ...
    MortgageTableComponent.prototype.onAddProductToCompare = function (loan) {
        this.loanService.addProductToCompare(loan);
        this.changeRef.detectChanges();
    };
    MortgageTableComponent.prototype.canAddProductToCompare = function (loanID) {
        return this.loanService.getSavedCompareProductList()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(function (loans) { return !!loans.find(function (l) { return l.lnID === loanID; }); }));
    };
    MortgageTableComponent.prototype.onSortChange = function (sortChange) {
    ...
    MortgageTableComponent.prototype.applyFilter = function (filterValue) {
    ...
    MortgageTableComponent.prototype.openDocumentDialog = function (documentData) {
        var data = documentData[this.translateService.getDefaultLang()];
    ...
    MortgageTableComponent.ctorParameters = function () { return [
...
var MortgageComponent = /** @class */ (function () {
    function MortgageComponent(titleService, translateService) {
        this.titleService = titleService;
        this.translateService = translateService;
        this.titleService.setTitle(this.translateService.instant('~mortgage'));
    }
    MortgageComponent.ctorParameters = function () { return [
...
var MortgageModule = /** @class */ (function () {
...
var MortgageRoutingModule = /** @class */ (function () {
    function MortgageRoutingModule() {
    }
...
//# sourceMappingURL=home-mortgage-mortgage-module-es5.js.map