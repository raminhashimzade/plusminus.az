...
var BestCreditCardOffersComponent = /** @class */ (function () {
    function BestCreditCardOffersComponent(bestOfferService) {
    ...
    BestCreditCardOffersComponent.prototype.ngOnInit = function () {
        this.offers$ = this.bestOfferService.getBestOffers('CREDIT_CARD');
    };
    BestCreditCardOffersComponent.prototype.ngOnDestroy = function () {
    };
    BestCreditCardOffersComponent.ctorParameters = function () { return [
    ...
    return BestCreditCardOffersComponent;
}());
...
var CreditCardOfferCardComponent = /** @class */ (function () {
    function CreditCardOfferCardComponent(translateService) {
        var _this = this;
        this.translateService = translateService;
        this.lang = this.translateService.getDefaultLang();
        this.translateService.onDefaultLangChange.subscribe(function (res) { return _this.lang = res; });
    }
    CreditCardOfferCardComponent.prototype.ngOnInit = function () {
    };
    CreditCardOfferCardComponent.ctorParameters = function () { return [
    ...
    return CreditCardOfferCardComponent;
}());
...
var BestCreditOffersComponent = /** @class */ (function () {
    function BestCreditOffersComponent(bestOfferService) {
        this.bestOfferService = bestOfferService;
        this.config = {
            a11y: true,
            direction: 'horizontal',
    ...
    BestCreditOffersComponent.prototype.ngOnInit = function () {
        this.offers$ = this.bestOfferService.getBestOffers('LOAN');
    };
    BestCreditOffersComponent.prototype.ngOnDestroy = function () {
    };
    BestCreditOffersComponent.ctorParameters = function () { return [
        { type: _best_offer_service__WEBPACK_IMPORTED_MODULE_2__["BestOfferService"] }
    ]; };
    ...
    return BestCreditOffersComponent;
}());
...
var CreditOfferCardComponent = /** @class */ (function () {
    function CreditOfferCardComponent(translateService) {
        var _this = this;
        this.translateService = translateService;
        this.lang = this.translateService.getDefaultLang();
        this.translateService.onDefaultLangChange.subscribe(function (res) { return _this.lang = res; });
    }
    CreditOfferCardComponent.prototype.ngOnInit = function () {
    };
    CreditOfferCardComponent.ctorParameters = function () { return [
        { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return CreditOfferCardComponent;
}());
...
var BestDebitCardOffersComponent = /** @class */ (function () {
    function BestDebitCardOffersComponent(bestOfferService) {
        this.bestOfferService = bestOfferService;
        this.config = {
            a11y: true,
            direction: 'horizontal',
    ...
    BestDebitCardOffersComponent.prototype.ngOnInit = function () {
        this.offers$ = this.bestOfferService.getBestOffers('DEBET_CARD');
    };
    BestDebitCardOffersComponent.prototype.ngOnDestroy = function () {
    };
    BestDebitCardOffersComponent.ctorParameters = function () { return [
        { type: _best_offer_service__WEBPACK_IMPORTED_MODULE_2__["BestOfferService"] }
    ]; };
    ...
    return BestDebitCardOffersComponent;
}());
...
var DebitCardOfferCardComponent = /** @class */ (function () {
    function DebitCardOfferCardComponent(translateService) {
        var _this = this;
        this.translateService = translateService;
        this.lang = this.translateService.getDefaultLang();
        this.translateService.onDefaultLangChange.subscribe(function (res) { return _this.lang = res; });
    }
    DebitCardOfferCardComponent.prototype.ngOnInit = function () {
    };
    DebitCardOfferCardComponent.ctorParameters = function () { return [
        { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return DebitCardOfferCardComponent;
}());
...
var BestDepositOfferComponent = /** @class */ (function () {
    function BestDepositOfferComponent(translateService) {
        var _this = this;
        this.translateService = translateService;
        this.lang = this.translateService.getDefaultLang();
        this.translateService.onDefaultLangChange.subscribe(function (res) { return _this.lang = res; });
    }
    BestDepositOfferComponent.ctorParameters = function () { return [
        { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__["TranslateService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return BestDepositOfferComponent;
}());
...
var BestDepositOffersComponent = /** @class */ (function () {
    function BestDepositOffersComponent(bestOfferService) {
        this.bestOfferService = bestOfferService;
        this.config = {
            a11y: true,
            direction: 'horizontal',
    ...
    BestDepositOffersComponent.prototype.ngOnInit = function () {
        this.offers$ = this.bestOfferService.getBestOffers('DEPOSIT');
    };
    BestDepositOffersComponent.prototype.ngOnDestroy = function () {
    };
    BestDepositOffersComponent.ctorParameters = function () { return [
        { type: _best_offer_service__WEBPACK_IMPORTED_MODULE_2__["BestOfferService"] }
    ]; };
    ...
    return BestDepositOffersComponent;
}());
...
var BestOfferService = /** @class */ (function () {
    function BestOfferService(authService, http) {
        this.authService = authService;
        this.http = http;
    }
    BestOfferService.prototype.getBestOffers = function (offerType) {
    ...
    BestOfferService.ctorParameters = function () { return [
...
var BestOffersComponent = /** @class */ (function () {
    function BestOffersComponent() {
        this.tabsCount = 5;
        this.selectedTabIndex = 0;
        this._onDestroy$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
    }
    BestOffersComponent.prototype.ngOnInit = function () {
        //   this.startSlide();
    };
    BestOffersComponent.prototype.startSlide = function () {
        var _this = this;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(6000)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this._onDestroy$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (res) {
            if (_this.selectedTabIndex + 1 < _this.tabsCount) {
    ...
    BestOffersComponent.prototype.onDestroy = function () {
...
var FavorableRatesPreviewComponent = /** @class */ (function () {
    function FavorableRatesPreviewComponent(homeService) {
        var _this = this;
        this.homeService = homeService;
        this.homeService.getcurrBestRateList().subscribe(function (res) {
            _this.rates = res;
        });
    }
    FavorableRatesPreviewComponent.prototype.ngOnInit = function () {
    };
    FavorableRatesPreviewComponent.ctorParameters = function () { return [
    ...
    return FavorableRatesPreviewComponent;
}());
...
var LandingPageComponent = /** @class */ (function () {
    function LandingPageComponent(titleService, tanslateService) {
...
var LoanSlideComponent = /** @class */ (function () {
    function LoanSlideComponent(dialog, translateService) {
        this.dialog = dialog;
        this.translateService = translateService;
    }
    LoanSlideComponent.prototype.ngOnInit = function () { };
    LoanSlideComponent.prototype.onRequestLoansFromAllBanks = function () {
        var ref = this.dialog.open(src_app_home_loans_loan_request_dialog_loan_request_dialog_component__WEBPACK_IMPORTED_MODULE_3__["LoanRequestDialogComponent"], {
    ...
    LoanSlideComponent.prototype.ngAfterViewInit = function () {
        // this.startTypedJs();
    };
    LoanSlideComponent.prototype.startTypedJs = function () {
        var options = {
            strings: [
    ...
    LoanSlideComponent.prototype.ngOnDestroy = function () {
        //   this.typed.destroy();
    };
    LoanSlideComponent.ctorParameters = function () { return [
...
var MortgageSlideComponent = /** @class */ (function () {
    function MortgageSlideComponent() {
    }
    MortgageSlideComponent.prototype.ngOnInit = function () {
    };
...
var BankPartnerCardComponent = /** @class */ (function () {
    function BankPartnerCardComponent() {
    }
    BankPartnerCardComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return BankPartnerCardComponent;
}());
...
var BankPartnersComponent = /** @class */ (function () {
    function BankPartnersComponent(homeService) {
        this.homeService = homeService;
        this.mockPartner = {
            bankID: 1,
        ...
        this.partners$ = this.homeService.getBankList(true)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (banks) {
            return banks && banks.filter(function (bank) { return bank.bankID === 1 ||
                bank.bankID === 12 ||
                bank.bankID === 16 ||
                bank.bankID === 8; });
        }));
    }
    BankPartnersComponent.prototype.ngOnInit = function () {
    };
    BankPartnersComponent.ctorParameters = function () { return [
        { type: _home_service__WEBPACK_IMPORTED_MODULE_1__["HomeService"] }
    ]; };
...
//# sourceMappingURL=home-landing-page-landing-page-module-es5.js.map