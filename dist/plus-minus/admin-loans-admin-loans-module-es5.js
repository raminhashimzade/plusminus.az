...
var AddOrEditLoanComponent = /** @class */ (function () {
    function AddOrEditLoanComponent(data, dialogRef, sharedAdminService, adminLoanService, adminService, translateService) {
        this.data = data;
    ...
    AddOrEditLoanComponent.prototype.ngOnInit = function () {
    ...
    AddOrEditLoanComponent.prototype.onUpdate = function () {
        var _this = this;
        if (!this.form.valid) {
            return;
        }
    ...
    AddOrEditLoanComponent.prototype.onAdd = function () {
        var _this = this;
        if (!this.form.valid) {
            return;
        }
    ...
    AddOrEditLoanComponent.prototype.onAddSuccess = function (res) {
        this.adminService
            .createNotification("[ LOAN ] " + this.translateService.instant('~addSuccess'), 'OK', 'success');
        this.dialogRef.close(res);
    };
    AddOrEditLoanComponent.prototype.onUpdateSuccess = function (res) {
        this.adminService
            .createNotification("[ LOAN ] " + this.translateService.instant('~updateSuccess'), 'OK', 'success');
        this.dialogRef.close(res);
    };
    AddOrEditLoanComponent.ctorParameters = function () { return [
...
var AdminLoanService = /** @class */ (function () {
    function AdminLoanService(http, adminPanelService) {
        this.http = http;
        this.adminPanelService = adminPanelService;
    }
    AdminLoanService.prototype.crudProduct = function (commandType, loanProduct) {
        if (loanProduct === void 0) { loanProduct = {}; }
        return this.http.post('mybank/crud/loanProduct', tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ adminToken: this.adminPanelService.token, commandType: commandType }, loanProduct)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res && res.data; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (er) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(null); }));
    };
    AdminLoanService.ctorParameters = function () { return [
...
var AdminLoansComponent = /** @class */ (function () {
    function AdminLoansComponent(adminLoanService, translateService, dialog, adminService, changeRef) {
        this.adminLoanService = adminLoanService;
        this.translateService = translateService;
        this.dialog = dialog;
        this.adminService = adminService;
    ...
    AdminLoansComponent.prototype.ngOnInit = function () {
        this.getData();
    };
    AdminLoansComponent.prototype.initToggleColumnControl = function () {
        var _this = this;
        this.toggleColumnsControl.setValue(this.allColumns);
        this.toggleColumnsControl.valueChanges.subscribe(function (res) {
            _this.allColumns = res;
            // this.changeRef.detectChanges();
        });
    };
    AdminLoansComponent.prototype.applyFilter = function (column, filterValue) {
    ...
    AdminLoansComponent.prototype.applyMultiLangFilter = function (column, filterValue) {
        this.dataSource.filterPredicate =
    ...
    AdminLoansComponent.prototype.isMultiLang = function (column) {
        if (column === 'editer') {
            return 'editer';
        }
        return (column === 'loanName' || column === 'description' || column === 'descriptionPD' || column === 'descriptionDOC') ? 'multilang' : 'standard';
    };
    AdminLoansComponent.prototype.getData = function () {
        var _this = this;
        ...
        this.adminLoanService.crudProduct(_models_crud_command_type_enum__WEBPACK_IMPORTED_MODULE_3__["CrudCommandType"].SELECT, {})
            ...
            columns.push('editer');
            _this.allColumns = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](columns).filter(function (column) { return (column !== 'description') && (column !== 'descriptionPD') && (column !== 'descriptionDOC') && (column !== 'lnId'); });
            _this.allColumns.unshift('lnId');
    ...
    AdminLoansComponent.prototype.getFilterValue = function (column) {
        if (!(this.dataFilterState && this.dataFilterState.column === column)) {
            return;
        }
        return this.dataFilterState.filterValue;
    };
    AdminLoansComponent.prototype.onEdit = function (item) {
        var _this = this;
        var ref = this.dialog.open(_add_or_edit_loan_add_or_edit_loan_component__WEBPACK_IMPORTED_MODULE_8__["AddOrEditLoanComponent"], tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ data: {
                item: item
    ...
    AdminLoansComponent.prototype.onAdd = function () {
        var _this = this;
        var ref = this.dialog.open(_add_or_edit_loan_add_or_edit_loan_component__WEBPACK_IMPORTED_MODULE_8__["AddOrEditLoanComponent"], tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ data: {} }, _admin_panel_utils__WEBPACK_IMPORTED_MODULE_9__["TableDialogConfig"]));
        ref.afterClosed().subscribe(function (res) { return res && _this.getData(); });
    };
    AdminLoansComponent.prototype.onDelete = function (element) {
        var _this = this;
        ...
        ref.afterClosed().subscribe(function (res) {
            if (res) {
                _this.adminLoanService.crudProduct(_models_crud_command_type_enum__WEBPACK_IMPORTED_MODULE_3__["CrudCommandType"].DELETE, element)
                    .subscribe(function (res) {
                    if (res) {
                        _this.adminService
                            .createNotification("[ LOAN ] " + _this.translateService.instant('~deleteSuccess'), 'OK', 'success');
                        _this.getData();
                    }
                });
            }
    ...
    AdminLoansComponent.prototype.showAllColumns = function () {
        this.visibleColumns = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.allColumns);
    };
    AdminLoansComponent.prototype.hideAllColumns = function () {
        this.visibleColumns = [];
    };
    AdminLoansComponent.prototype.onToggleColumns = function (columns) {
        this.visibleColumns = columns;
    };
    AdminLoansComponent.ctorParameters = function () { return [
...
var AdminLoansModule = /** @class */ (function () {
    function AdminLoansModule() {
    }
...
var AdminLoansRoutingModule = /** @class */ (function () {
    function AdminLoansRoutingModule() {
    }
    ...
    return AdminLoansRoutingModule;
}());
...
//# sourceMappingURL=admin-loans-admin-loans-module-es5.js.map