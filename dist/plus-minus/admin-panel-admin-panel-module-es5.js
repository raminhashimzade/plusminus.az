...
var AdminLoginComponent = /** @class */ (function () {
    function AdminLoginComponent(router, adminService) {
        this.router = router;
...
var AdminNavigationComponent = /** @class */ (function () {
    function AdminNavigationComponent(translateService, adminPanelService, router, platformId) {
    ...
    AdminNavigationComponent.prototype.goToMainPage = function () {
    ...
    AdminNavigationComponent.prototype.onLangChange = function (lang) {
        this.currentLang = lang;
        this.translateService.setDefaultLang(lang);
        //  this.adminPanelService.langChange$.next(lang);
    };
    AdminNavigationComponent.prototype.onFullScreen = function () {
    ...
    AdminNavigationComponent.prototype.onThemeChange = function () {
        if (!Object(_angular_common__WEBPACK_IMPORTED_MODULE_5__["isPlatformBrowser"])(this.platformId)) {
            return;
        }
        var root = document.documentElement;
    ...
    AdminNavigationComponent.ctorParameters = function () { return [
...
var AdminPanelComponent = /** @class */ (function () {
    function AdminPanelComponent(adminPanelService) {
        var _this = this;
        this.adminPanelService = adminPanelService;
        this.adminPanelService.fullScreen$.subscribe(function (res) { return (_this.isFullScreen = res); });
    }
    AdminPanelComponent.prototype.handleEsc = function (event) {
...
var AdminPanelGuard = /** @class */ (function () {
    function AdminPanelGuard(adminPanelService, router) {
        this.adminPanelService = adminPanelService;
        this.router = router;
    }
    AdminPanelGuard.prototype.canActivate = function (route, state) {
        var token = this.adminPanelService.getToken();
        if (token) {
            return true;
        }
        this.router.navigateByUrl('/admin/login');
    };
    AdminPanelGuard.ctorParameters = function () { return [
        { type: _admin_panel_service__WEBPACK_IMPORTED_MODULE_3__["AdminPanelService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
