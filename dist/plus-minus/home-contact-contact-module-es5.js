...
var ContactComponent = /** @class */ (function () {
    function ContactComponent(translateService, titleService, contactService, sharedService, dialog) {
    ...
    ContactComponent.prototype.onTelInput = function (e) {
        var value = e.target.value;
        this.form.controls['cusMobilePhone'].setValue(value.replace(/[^\d]/, ''));
    };
    ContactComponent.prototype.onSubmit = function () {
        var _this = this;
        var gsm = "994" + this.inputPrefix + this.form.controls['cusMobilePhone'].value;
        if (!this.form.valid) {
            return;
        }
        var dialogRef = this.openOtpVerifyDialog(gsm);
        dialogRef.afterClosed().subscribe(function (res) {
            if (res) {
                _this.postCustomerMessage();
            }
        });
    };
    ContactComponent.prototype.postCustomerMessage = function () {
        var _this = this;
        var gsm = "994" + this.inputPrefix + this.form.controls['cusMobilePhone'].value;
        var newFormValue = {
            cusMobilePhone: gsm,
        ...
        this.contactService.postCustomerMessage(newFormValue)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () { return _this.loading = false; })).subscribe(function (res) {
            _this.isSent = true;
            _this.sharedService.createNotification(_this.translateService.instant('~messageSent'), 'OK', 'success');
        });
    };
    ContactComponent.prototype.openOtpVerifyDialog = function (gsm) {
        var dialogRef = this.dialog.open(src_app_shared_components_otp_verify_otp_verify_component__WEBPACK_IMPORTED_MODULE_8__["OtpVerifyComponent"], {
            data: {
                otpObject: {
                    gsm: gsm
                }
...
var ContactService = /** @class */ (function () {
    function ContactService(http, authService) {
        this.http = http;
        this.authService = authService;
    }
    ContactService.prototype.postCustomerMessage = function (formValue) {
        return this.http.post('mybank/postCustomerMessage', tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, formValue, { token: this.authService.getToken() }));
    };
...
var OtpVerifyComponent = /** @class */ (function () {
    function OtpVerifyComponent(sharedService, translateService, dialogRef, data) {
        this.sharedService = sharedService;
        this.translateService = translateService;
    ...
    OtpVerifyComponent.prototype.ngOnDestroy = function () {
        this._onDestroy$.next();
    };
    OtpVerifyComponent.prototype.initTimer = function () {
        var _this = this;
        var source = Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["timer"])(1000, 1000)
        ...
        var subscription = source.subscribe(function (res) {
            _this.resendLeftTime = _this.resendLeftTime - 1;
            if (res >= _this.resendTimerInterval) {
                subscription.unsubscribe();
                _this.canResendOtp = true;
            }
        });
    };
    OtpVerifyComponent.prototype.sendOtp = function () {
        this.canResendOtp = false;
        var otpObject = this.data.otpObject;
        if (!otpObject) {
            return;
        }
    ...
    OtpVerifyComponent.prototype.onSubmit = function () {
        var _this = this;
        if (!this.form.valid) {
            return;
        }
    ...
    OtpVerifyComponent.prototype.onKeyUp = function (controlKey, nextInput, e) {
        var value = e.target.value;
    ...
    OtpVerifyComponent.prototype.onFocus = function (controlKey) {
        this.form.controls[controlKey].setValue('');
    };
    OtpVerifyComponent.prototype.getErrorMessage = function (controlKey) {
        return this.form.controls[controlKey].hasError('required') ?
            this.translateService.instant('~requiredField') : '';
    };
    OtpVerifyComponent.prototype.onCodeInput = function (controlKey, e) {
        var value = e.target.value;
        this.form.controls[controlKey].setValue(value.replace(/[^\d]/, ''));
    };
    OtpVerifyComponent.prototype.onStepBack = function () {
        this.dialogRef.close();
    };
    OtpVerifyComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=home-contact-contact-module-es5.js.map