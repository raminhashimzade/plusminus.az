...
var CreditCardLoaderComponent = /** @class */ (function () {
    function CreditCardLoaderComponent() {
        this.items = new Array(5);
    }
    CreditCardLoaderComponent.prototype.ngOnInit = function () {
    };
    ...
    return CreditCardLoaderComponent;
}());
...
var CreditCardsFilterComponent = /** @class */ (function () {
    function CreditCardsFilterComponent(translateService, sharedService, router, route, 
    ...
    CreditCardsFilterComponent.prototype.resize = function () { this.updateForLayoutChange(); };
    CreditCardsFilterComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () { return _this.listenToformChange(); }, 10);
        this.isMdSize = this.breakPointObserver.isMatched('(max-width: 992px)');
    };
    Object.defineProperty(CreditCardsFilterComponent.prototype, "isContainerFluid", {
        get: function () {
    ...
    CreditCardsFilterComponent.prototype.updateForLayoutChange = function () {
        this.isMdSize = this.breakPointObserver.isMatched('(max-width: 992px)');
    };
    CreditCardsFilterComponent.prototype.ngOnDestroy = function () {
        this._onDestroy$.next();
    };
    CreditCardsFilterComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        setTimeout(function () { return _this.listenToRouterParams(); });
    };
    CreditCardsFilterComponent.prototype.listenToRouterParams = function () {
        var _this = this;
        this.route.params
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["takeUntil"])(this._onDestroy$))
            .subscribe(function (res) {
            var loanAmount = res['loanAmount'];
            if (loanAmount) {
                _this.slideValue = +loanAmount;
            }
    ...
    CreditCardsFilterComponent.prototype.listenToformChange = function () {
        var _this = this;
    ...
    CreditCardsFilterComponent.prototype.onSubmit = function () {
        this.searchLoans(true);
    };
    CreditCardsFilterComponent.prototype.searchLoans = function (scrollIntoView) {
        var _this = this;
        ...
        this.router.navigate(['/home/credit-cards', tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, filterForm)]);
    };
    CreditCardsFilterComponent.prototype.getErrorMessage = function (controlKey) {
        return this.form.controls[controlKey].hasError('required') ?
            this.translateService.instant('~requiredField') : '';
    };
    CreditCardsFilterComponent.prototype.onSlideMove = function (change) {
        this.slideValue = change.value;
        this.creditCardFilter.loanAmount = this.slideValue;
    };
    CreditCardsFilterComponent.ctorParameters = function () { return [
    ...
    return CreditCardsFilterComponent;
}());
...
module.exports = ":host {\n  display: block;\n  flex: 1 1 0;\n  background: var(--background-secondary);\n}\n\n.items-group {\n  box-shadow: 0.0625rem 0.125rem 0.6875rem 0 rgba(0, 0, 0, 0.2);\n  margin-bottom: 20px;\n}\n\n.items-group .card {\n  display: flex;\n  flex-direction: row;\n  box-shadow: none;\n  padding: 30px;\n  border: solid 1px rgba(0, 0, 0, 0.12);\n  transition: backgroun-color 100ms ease-in-out;\n}\n\n.items-group .card:hover {\n  background-color: #f5f6fa;\n}\n\n.items-group .card .card__icon {\n  flex: 0 0 var(--credit-card-width);\n  height: var(--credit-card-height);\n  max-height: 175px;\n  margin-bottom: 10px;\n}\n\n.items-group .card .card__icon img {\n  height: var(--credit-card-height);\n  width: var(--credit-card-width);\n  box-shadow: 0 0 4px 0 rgba(0, 0, 0, 0.14), 0 3px 4px 0 rgba(0, 0, 0, 0.12), 0 1px 5px 0 rgba(0, 0, 0, 0.2);\n  border-radius: 4px;\n  transition: transform 300ms ease-in-out;\n}\n\n.items-group .card .card__icon img:hover {\n  transform: scale(1.2);\n}\n\n.items-group .card .card__content {\n  display: flex;\n  flex-direction: column;\n}\n\n.items-group .card .card__content .card__content__header {\n  padding-left: 2.1875rem;\n}\n\n.items-group .card .card__content .card__content__header .card__content__header__bankName {\n  font-family: \"Montserrat-Medium\";\n  font-size: 13px;\n  font-weight: 400;\n  letter-spacing: -0.36px;\n}\n\n.items-group .card .card__content .card__content__header .card__content__header__name {\n  font-family: \"Montserrat-SemiBold\";\n  font-size: 1.0625rem;\n  font-weight: 400;\n  letter-spacing: -0.48px;\n  color: var(--primary-default);\n  margin-bottom: 1.125rem;\n}\n\n.items-group .card .card__content .card__content__features {\n  display: flex;\n  flex-wrap: wrap;\n  width: 94%;\n}\n\n.items-group .card .card__content .card__content__features .card__content__features__info {\n  display: flex;\n  align-items: center;\n  margin-bottom: 10px;\n  width: 50%;\n  padding-left: 2.1875rem;\n}\n\n.items-group .card .card__content .card__content__features .card__content__features__info .card__content__features__info__key {\n  font-family: \"Montserrat-SemiBold\";\n  color: #000000;\n  font-size: 15px;\n  letter-spacing: -0.42px;\n  margin-right: 10px;\n  white-space: nowrap;\n}\n\n.items-group .card .card__content .card__content__features .card__content__features__info .card__content__features__info__value {\n  font-family: \"Montserrat-Medium\";\n  color: #000000;\n  font-size: 13px;\n  font-weight: 400;\n  letter-spacing: -0.36px;\n  white-space: nowrap;\n}\n\n.items-group .card .card__content .card__content__features .card__content__features__info .card__content__features__info__value.--icon {\n  color: var(--primary-default);\n  font-size: 16px;\n}\n\n.items-group .card .card__actions {\n  margin-left: auto;\n  flex: 0 0 120px;\n}\n\n.items-group .card .card__actions a {\n  width: 100%;\n  margin-bottom: 10px;\n}\n\n@media (max-width: 992px) {\n  .items-group .card .card__content .card__content__features {\n    width: 100%;\n    flex-direction: column;\n  }\n}\n\n@media (max-width: 768px) {\n  .items-group .card {\n    flex-direction: column;\n  }\n  .items-group .card .card__content .card__content__header {\n    padding-left: 0;\n  }\n  .items-group .card .card__content .card__content__features {\n    flex-direction: column;\n  }\n  .items-group .card .card__content .card__content__features .card__content__features__info {\n    padding-left: 0;\n    width: 100%;\n  }\n  .items-group .card .card__content .card__content__features .card__content__features__info .card__content__features__info__key {\n    font-size: 13px;\n  }\n  .items-group .card .card__actions {\n    margin-left: 0;\n    margin-top: 10px;\n  }\n}\n\n@media (max-width: 576px) {\n  .items-group .card .card__actions a {\n    width: 220px;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var CreditCardsTableComponent = /** @class */ (function () {
    function CreditCardsTableComponent(route, productService, changeRef, breakpointObserver, sharedService, dialog, translateService, titleService) {
        this.route = route;
        this.productService = productService;
    ...
    CreditCardsTableComponent.prototype.resize = function () { this.updateForLayoutChange(); };
    CreditCardsTableComponent.prototype.ngOnInit = function () {
        this.listenToRouterParams();
        this.changeRef.detectChanges();
    };
    Object.defineProperty(CreditCardsTableComponent.prototype, "isLGSize", {
        get: function () {
    ...
    Object.defineProperty(CreditCardsTableComponent.prototype, "showDocuments", {
        get: function () {
    ...
    CreditCardsTableComponent.prototype.onExpandGroup = function (groupId) {
    ...
    CreditCardsTableComponent.prototype.ngOnDestroy = function () {
        this._onDestroy$.next();
    };
    CreditCardsTableComponent.prototype.updateForLayoutChange = function () {
        this.changeRef.detectChanges();
    };
    CreditCardsTableComponent.prototype.listenToRouterParams = function () {
        var _this = this;
        this.route.params
            ...
            var scrollIntoView = res['scrollIntoView'] === 'true';
            _this.getListcreditCardGroups(formValue, scrollIntoView);
        });
        this.changeRef.detectChanges();
    };
    CreditCardsTableComponent.prototype.getListcreditCardGroups = function (data, scrollIntoView) {
        var _this = this;
        ...
        this.productService.getListGCardCreditProduct(data)
            ...
            .subscribe(function (res) {
            _this.creditCardGroups = res;
            _this.filteredGroupProducts = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.creditCardGroups);
            //   if (scrollIntoView) {switchToView('#products-table-filter') }
        });
    };
    CreditCardsTableComponent.prototype.onAddProductToCompare = function (product) {
        this.productService.addProductToCompare(product);
        this.changeRef.detectChanges();
    };
    CreditCardsTableComponent.prototype.canAddProductToCompare = function (loanID) {
        return this.productService.getSavedCompareProductList()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (products) { return !!products.find(function (l) { return l.cdId === loanID; }); }));
    };
    CreditCardsTableComponent.prototype.onSortChange = function (sortChange) {
        this.sortState = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, sortChange);
        this.filteredGroupProducts = this.sharedService.sortTableWithRowGroups(this.sortState, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.creditCardGroups));
        this.changeRef.detectChanges();
    };
    CreditCardsTableComponent.prototype.applyFilter = function (filterValue) {
        this.filteredGroupProducts = this.sharedService.
            filterTableWithRowGroups(filterValue, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.creditCardGroups), ['bankName']);
        this.changeRef.detectChanges();
    };
    CreditCardsTableComponent.ctorParameters = function () { return [
    ...
    return CreditCardsTableComponent;
}());
...
var CreditCardsComponent = /** @class */ (function () {
    function CreditCardsComponent() {
    }
    CreditCardsComponent.prototype.ngOnInit = function () {
    };
...
var CreditCardsRoutingModule = /** @class */ (function () {
    function CreditCardsRoutingModule() {
    }
    ...
    return CreditCardsRoutingModule;
}());
...
module.exports = ":host {\n  display: block;\n  flex: 1 0 0;\n}\n\n.productsCompare .productsCompare__content {\n  margin-top: 20px;\n  position: relative;\n  box-shadow: 0.0625rem 0.125rem 0.6875rem 0 rgba(0, 0, 0, 0.2);\n  border: 1px solid #e1e1e1;\n}\n\ntable.products {\n  box-shadow: none;\n  border: 0;\n}\n\ntable.products th {\n  border: 0;\n  position: -webkit-sticky;\n  position: sticky;\n  top: 80px;\n  background: white;\n  z-index: 8;\n}\n\ntable.products th .th-content {\n  color: inherit;\n}\n\ntable.products td.td-documents {\n  vertical-align: middle;\n}\n\ntable.products td.td-documents .document-chip {\n  cursor: pointer;\n  background-color: var(--secondary-light);\n}\n\ntable.products td .td-content {\n  min-width: 170px;\n  white-space: nowrap;\n}\n\ntable.products td .td-content.--documents {\n  font-size: 18px;\n  height: 32px;\n  display: flex;\n  justify-content: flex-start;\n}\n\ntable.products td .td-content a {\n  color: #2980b9;\n  cursor: pointer;\n}\n\ntable.products .th-content, table.products .td-content {\n  overflow: hidden;\n}\n\ntable.products .th-content.--first, table.products .td-content.--first {\n  width: 200px;\n  text-align: left;\n  justify-content: flex-start;\n}\n\n.arrows {\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n  position: -webkit-sticky;\n  position: sticky;\n  top: 90px;\n  z-index: 10;\n  height: 0;\n}\n\n.arrows .arrow {\n  font-size: 18px;\n}\n\n.arrows .arrow.--prev {\n  transform: translateX(-25px) rotateY(180deg);\n}\n\n.arrows .arrow.--next {\n  transform: translateX(25px);\n}\n\n@media (max-width: 576px) {\n  table.products th {\n    top: 0;\n  }\n\n  .productsCompare .productsCompare__content .productsCompare__content__table th:first-child {\n    width: 100px;\n  }\n  .productsCompare .productsCompare__content .productsCompare__content__table .th-content, .productsCompare .productsCompare__content .productsCompare__content__table .td-content {\n    width: 150px;\n  }\n  .productsCompare .productsCompare__content .productsCompare__content__table .th-content.--first, .productsCompare .productsCompare__content .productsCompare__content__table .td-content.--first {\n    width: 100px;\n  }\n\n  .arrows .arrow.--prev {\n    transform: translateX(0px) rotateY(180deg);\n  }\n  .arrows .arrow.--next {\n    transform: translateX(0px);\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var CredtCardCompareComponent = /** @class */ (function () {
    function CredtCardCompareComponent(productService, router, route, dialog, translateService, platformId) {
        this.productService = productService;
        this.router = router;
        this.route = route;
        this.dialog = dialog;
    ...
    CredtCardCompareComponent.prototype.resize = function () { this.buildView(); };
    CredtCardCompareComponent.prototype.ngOnInit = function () {
    ...
    CredtCardCompareComponent.prototype.getPreviewProduct = function (id) {
        var _this = this;
        this.loading = true;
    ...
    CredtCardCompareComponent.prototype.getCompareProductList = function () {
        var _this = this;
        this.loading = true;
        ...
        this.productService.getSavedCompareProductList()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (products) { return products.map(function (p) { return p.cdId; }); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (productIds) { return _this.productService.getCompareProductList(productIds, _this.productService.productFilterValue); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(function () { return _this.loading = false; })).subscribe(function (res) {
            if (!res) {
                return;
            }
            _this.products = res;
    ...
    CredtCardCompareComponent.prototype.setVisibleProducts = function () {
        this.setItemsPerTable();
        this.visibleProducts = this.products.slice(this.pageIndex, this.pageIndex + this.itemsPerTable);
    };
    CredtCardCompareComponent.prototype.onPrevProduct = function () {
    ...
    CredtCardCompareComponent.prototype.onNextProduct = function () {
    ...
    CredtCardCompareComponent.prototype.hasPrevProduct = function () {
        return this.pageIndex !== 0;
    };
    CredtCardCompareComponent.prototype.hasNextProduct = function () {
        if (!this.products) {
            return;
        }
        return !(this.pageIndex + this.itemsPerTable >= this.products.length);
    };
    CredtCardCompareComponent.prototype.setItemsPerTable = function () {
    ...
    CredtCardCompareComponent.prototype.buildView = function () {
    ...
    CredtCardCompareComponent.prototype.openDocumentDialog = function (documentData, type) {
    ...
    CredtCardCompareComponent.ctorParameters = function () { return [
    ...
    return CredtCardCompareComponent;
}());
...
var CreditCardFilterForm = /** @class */ (function () {
    function CreditCardFilterForm() {
...
//# sourceMappingURL=home-credit-cards-credit-cards-module-es5.js.map