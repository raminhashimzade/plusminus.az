...
var AddOrEditDepositComponent = /** @class */ (function () {
    function AddOrEditDepositComponent(data, dialogRef, sharedAdminService, adminDepositService, adminService, translateService) {
        this.data = data;
    ...
    AddOrEditDepositComponent.prototype.ngOnInit = function () {
    ...
    AddOrEditDepositComponent.prototype.onUpdate = function () {
        var _this = this;
        if (!this.form.valid) {
            return;
        }
        ...
        this.adminDepositService.crudDepositProduct(_models_crud_command_type_enum__WEBPACK_IMPORTED_MODULE_4__["CrudCommandType"].UPDATE, this.depositProduct)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["finalize"])(function () { return _this.loading = false; }))
    ...
    AddOrEditDepositComponent.prototype.onAdd = function () {
        var _this = this;
        if (!this.form.valid) {
            return;
        }
        ...
        this.adminDepositService.crudDepositProduct(_models_crud_command_type_enum__WEBPACK_IMPORTED_MODULE_4__["CrudCommandType"].INSERT, this.depositProduct)
            ...
            .subscribe(function (res) {
            if (res) {
                _this.onAddSuccess(res);
            }
        });
    };
    AddOrEditDepositComponent.prototype.onAddSuccess = function (res) {
        this.adminService
            .createNotification("[ Deposit ] " + this.translateService.instant('~addSuccess'), 'OK', 'success');
        this.dialogRef.close(res);
    };
    AddOrEditDepositComponent.prototype.onUpdateSuccess = function (res) {
        this.adminService
            .createNotification("[ Deposit ] " + this.translateService.instant('~updateSuccess'), 'OK', 'success');
        this.dialogRef.close(res);
    };
    AddOrEditDepositComponent.ctorParameters = function () { return [
    ...
    return AddOrEditDepositComponent;
}());
...
var AdminDepositService = /** @class */ (function () {
    function AdminDepositService(http, adminPanelService) {
        this.http = http;
        this.adminPanelService = adminPanelService;
    }
    AdminDepositService.prototype.crudDepositProduct = function (commandType, loanProduct) {
        if (loanProduct === void 0) { loanProduct = {}; }
        return this.http.post('mybank/crud/depositProduct', tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ adminToken: this.adminPanelService.token, commandType: commandType }, loanProduct)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res && res.data; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (er) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null); }));
    };
    AdminDepositService.ctorParameters = function () { return [
...
var AdminDepositsComponent = /** @class */ (function () {
    function AdminDepositsComponent(adminDepositService, translateService, dialog, adminService, changeRef) {
        this.adminDepositService = adminDepositService;
        this.translateService = translateService;
        this.dialog = dialog;
        this.adminService = adminService;
    ...
    AdminDepositsComponent.prototype.ngOnInit = function () {
        this.getData();
    };
    AdminDepositsComponent.prototype.applyFilter = function (column, filterValue) {
        this.dataSource.filterPredicate =
            function (data, filter) { return data[column].toString().toLowerCase().includes(filter.toLowerCase()); };
        this.dataSource.filter = filterValue;
        this.dataFilterState = { column: column, filterValue: filterValue, multi: false };
    };
    AdminDepositsComponent.prototype.applyMultiLangFilter = function (column, filterValue) {
        this.dataSource.filterPredicate =
            function (data, filter) { return data[column]['az'].toLowerCase().includes(filter.toLowerCase()); };
        this.dataSource.filter = filterValue;
        this.dataFilterState = { column: column, filterValue: filterValue, multi: true };
    };
    AdminDepositsComponent.prototype.isMultiLang = function (column) {
        if (column === 'editer') {
            return 'editer';
        }
        return (column === 'depositName' || column === 'description' || column === 'present') ? 'multilang' : 'standard';
    };
    AdminDepositsComponent.prototype.getData = function () {
        var _this = this;
        ...
        this.adminDepositService.crudDepositProduct(_models_crud_command_type_enum__WEBPACK_IMPORTED_MODULE_8__["CrudCommandType"].SELECT, {})
            ...
            _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](res);
            if (_this.dataFilterState) {
                var _a = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _this.dataFilterState), column = _a.column, filterValue = _a.filterValue, multi = _a.multi;
                multi ? _this.applyMultiLangFilter(column, filterValue) :
                    _this.applyFilter(column, filterValue);
            }
            var columns = Object.keys(res[0]);
            columns.push('editer');
            _this.allColumns = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](columns).filter(function (column) { return (column !== 'description') && (column !== 'descriptionPD') && (column !== 'descriptionDOC') && (column !== 'dpId'); });
            _this.allColumns.unshift('dpId');
            _this.visibleColumns = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.allColumns);
            setTimeout(function () {
    ...
    AdminDepositsComponent.prototype.getFilterValue = function (column) {
        if (!(this.dataFilterState && this.dataFilterState.column === column)) {
            return;
        }
        return this.dataFilterState.filterValue;
    };
    AdminDepositsComponent.prototype.onEdit = function (item) {
        var _this = this;
        var ref = this.dialog.open(_add_or_edit_deposit_add_or_edit_deposit_component__WEBPACK_IMPORTED_MODULE_12__["AddOrEditDepositComponent"], tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ data: {
                item: item
    ...
    AdminDepositsComponent.prototype.onAdd = function () {
        var _this = this;
        var ref = this.dialog.open(_add_or_edit_deposit_add_or_edit_deposit_component__WEBPACK_IMPORTED_MODULE_12__["AddOrEditDepositComponent"], tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ data: {} }, _admin_panel_utils__WEBPACK_IMPORTED_MODULE_9__["TableDialogConfig"]));
        ref.afterClosed().subscribe(function (res) { return res && _this.getData(); });
    };
    AdminDepositsComponent.prototype.onDelete = function (element) {
        var _this = this;
        var ref = this.dialog.open(_shared_components_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_10__["ConfirmDialogComponent"], {
            data: {
        ...
        ref.afterClosed().subscribe(function (res) {
            if (res) {
                _this.adminDepositService.crudDepositProduct(_models_crud_command_type_enum__WEBPACK_IMPORTED_MODULE_8__["CrudCommandType"].DELETE, element)
                    .subscribe(function (res) {
                    if (res) {
                        _this.adminService
                            .createNotification("[ Deposit ] " + _this.translateService.instant('~deleteSuccess'), 'OK', 'success');
                        _this.getData();
                    }
                });
            }
    ...
    AdminDepositsComponent.prototype.showAllColumns = function () {
        this.visibleColumns = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.allColumns);
    };
    AdminDepositsComponent.prototype.hideAllColumns = function () {
        this.visibleColumns = [];
    };
    AdminDepositsComponent.prototype.onToggleColumns = function (columns) {
        this.visibleColumns = columns;
    };
    AdminDepositsComponent.ctorParameters = function () { return [
...
var AdminDepositsModule = /** @class */ (function () {
    function AdminDepositsModule() {
    }
...
var AdminDepositsRoutingModule = /** @class */ (function () {
    function AdminDepositsRoutingModule() {
    }
    ...
    return AdminDepositsRoutingModule;
}());
...
var DepositProduct = /** @class */ (function () {
...
//# sourceMappingURL=admin-deposits-admin-deposits-module-es5.js.map