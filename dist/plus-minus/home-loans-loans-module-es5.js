...
var BankCheckboxLoaderComponent = /** @class */ (function () {
    function BankCheckboxLoaderComponent() {
        this.items = new Array(7);
    }
    BankCheckboxLoaderComponent.prototype.ngOnInit = function () {
    };
    ...
    return BankCheckboxLoaderComponent;
}());
...
var EndLoanOrderComponent = /** @class */ (function () {
    function EndLoanOrderComponent(homeService, changeRef) {
        this.homeService = homeService;
        this.changeRef = changeRef;
    }
    EndLoanOrderComponent.prototype.ngOnInit = function () {
        this.getBankList();
    };
    EndLoanOrderComponent.prototype.getBankList = function () {
        var _this = this;
        this.loading = true;
        this.homeService.getBankList(true)
            ...
            _this.options = res && res.map(function (bank) {
                return {
                    bankID: bank.bankID,
                    checked: false
                };
    ...
    Object.defineProperty(EndLoanOrderComponent.prototype, "isChecked", {
        get: function () {
            if (!this.options) {
                return;
            }
    ...
    EndLoanOrderComponent.prototype.onBankToggle = function (event, bankID) {
        this.options = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.options).map(function (option) {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, option, { checked: option.bankID === bankID ? true : false });
        });
    };
    EndLoanOrderComponent.ctorParameters = function () { return [
...
module.exports = ":host {\n  display: block;\n  min-height: 800px;\n}\n\n.productsCompare .productsCompare__content {\n  margin-top: 20px;\n  position: relative;\n  box-shadow: 0.0625rem 0.125rem 0.6875rem 0 rgba(0, 0, 0, 0.2);\n  border: 1px solid #e1e1e1;\n}\n\ntable.products {\n  box-shadow: none;\n  border: 0;\n}\n\ntable.products th {\n  border: 0;\n  position: -webkit-sticky;\n  position: sticky;\n  top: 80px;\n  background: white;\n  z-index: 8;\n}\n\ntable.products th .th-content {\n  color: inherit;\n}\n\ntable.products td.td-documents {\n  vertical-align: middle;\n}\n\ntable.products td.td-documents .document-chip {\n  cursor: pointer;\n  background-color: var(--secondary-light);\n}\n\ntable.products td .td-content {\n  white-space: nowrap;\n  min-width: 170px;\n}\n\ntable.products td .td-content.--documents {\n  font-size: 18px;\n  height: 32px;\n  display: flex;\n  justify-content: center;\n}\n\ntable.products td .td-content a {\n  color: #2980b9;\n  cursor: pointer;\n}\n\ntable.products .th-content,\ntable.products .td-content {\n  height: 21px;\n  overflow: hidden;\n}\n\ntable.products .th-content.--first,\ntable.products .td-content.--first {\n  width: 200px;\n  text-align: left;\n  justify-content: flex-start;\n}\n\n.arrows {\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n  position: -webkit-sticky;\n  position: sticky;\n  top: 90px;\n  z-index: 10;\n  height: 0;\n}\n\n.arrows .arrow {\n  font-size: 18px;\n}\n\n.arrows .arrow.--prev {\n  transform: translateX(-25px) rotateY(180deg);\n}\n\n.arrows .arrow.--next {\n  transform: translateX(25px);\n}\n\n@media (max-width: 576px) {\n  table.products th {\n    top: 0;\n  }\n\n  .productsCompare .productsCompare__content .productsCompare__content__table th:first-child {\n    width: 100px;\n  }\n  .productsCompare .productsCompare__content .productsCompare__content__table .th-content,\n.productsCompare .productsCompare__content .productsCompare__content__table .td-content {\n    width: 150px;\n  }\n  .productsCompare .productsCompare__content .productsCompare__content__table .th-content.--first,\n.productsCompare .productsCompare__content .productsCompare__content__table .td-content.--first {\n    width: 100px;\n  }\n\n  .arrows .arrow.--prev {\n    transform: translateX(0px) rotateY(180deg);\n  }\n  .arrows .arrow.--next {\n    transform: translateX(0px);\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var LoansCompareComponent = /** @class */ (function () {
    function LoansCompareComponent(loanService, router, route, dialog, translateService, platformId) {
    ...
    LoansCompareComponent.prototype.resize = function () { this.buildView(); };
    LoansCompareComponent.prototype.ngOnInit = function () {
        var id = this.route.snapshot.queryParams['lnID'];
        if (id) {
    ...
    LoansCompareComponent.prototype.getPreviewProduct = function (id) {
        var _this = this;
        this.loading = true;
    ...
    LoansCompareComponent.prototype.getCompareProductList = function () {
        var _this = this;
        this.loading = true;
        ...
        this.loanService.getSavedCompareProductList()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (products) { return products.map(function (p) { return p.lnID; }); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (productIds) { return _this.loanService.getCompareProductList(productIds, _this.loanService.loanFilterValue); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(function () { return _this.loading = false; })).subscribe(function (res) {
            if (!res) {
                return;
            }
            _this.products = res;
    ...
    LoansCompareComponent.prototype.setVisibleProducts = function () {
        this.setItemsPerTable();
        this.visibleProducts = this.products.slice(this.pageIndex, this.pageIndex + this.itemsPerTable);
    };
    LoansCompareComponent.prototype.onPrevProduct = function () {
    ...
    LoansCompareComponent.prototype.onNextProduct = function () {
    ...
    LoansCompareComponent.prototype.hasPrevProduct = function () {
        return this.pageIndex !== 0;
    };
    LoansCompareComponent.prototype.hasNextProduct = function () {
        if (!this.products) {
            return;
        }
        return !(this.pageIndex + this.itemsPerTable >= this.products.length);
    };
    LoansCompareComponent.prototype.setItemsPerTable = function () {
    ...
    LoansCompareComponent.prototype.buildView = function () {
        this.isMobile = Object(src_app_app_utils__WEBPACK_IMPORTED_MODULE_5__["isMobileSize"])();
        this.setVisibleProducts();
    };
    LoansCompareComponent.prototype.openDocumentDialog = function (documentData, type) {
    ...
    LoansCompareComponent.ctorParameters = function () { return [
...
var LoansFilterComponent = /** @class */ (function () {
    function LoansFilterComponent(translateService, productService, sharedService, router, route, dialog, breakPointObserver) {
        this.translateService = translateService;
    ...
    LoansFilterComponent.prototype.resize = function () { this.updateForLayoutChange(); };
    LoansFilterComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () { return _this.listenToformChange(); }, 20);
        this.isMdSize = this.breakPointObserver.isMatched('(max-width: 992px)');
    };
    Object.defineProperty(LoansFilterComponent.prototype, "isContainerFluid", {
        get: function () {
    ...
    LoansFilterComponent.prototype.updateForLayoutChange = function () {
        this.isMdSize = this.breakPointObserver.isMatched('(max-width: 992px)');
    };
    LoansFilterComponent.prototype.ngOnDestroy = function () {
        this._onDestroy$.next();
    };
    LoansFilterComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.listenToSlideMove();
        setTimeout(function () { return _this.listenToRouterParams(); }, 10);
    };
    LoansFilterComponent.prototype.listenToRouterParams = function () {
        var _this = this;
        this.route.params
            ...
            if (loanAmount) {
                ...
                _this.productFilter.loanAmount = _this.slideValue;
            }
            ...
            _this.productService.loanFilterValue = Object(src_app_app_utils__WEBPACK_IMPORTED_MODULE_9__["deepClone"])(_this.form.value);
        });
    };
    LoansFilterComponent.prototype.listenToformChange = function () {
        var _this = this;
    ...
    LoansFilterComponent.prototype.onSubmit = function () {
        this.searchProducts();
        this.searchSubmit.next(this.form.value);
    };
    LoansFilterComponent.prototype.searchProducts = function () {
        var _this = this;
        var filterForm = {};
        ...
        this.router.navigate(['/home/loans', tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, filterForm)]);
    };
    LoansFilterComponent.prototype.getErrorMessage = function (controlKey) {
        return this.form.controls[controlKey].hasError('required') ?
            this.translateService.instant('~requiredField') : '';
    };
    LoansFilterComponent.prototype.onSlideMove = function (change) {
        this.slideChange$.next(change.value);
    };
    LoansFilterComponent.prototype.listenToSlideMove = function () {
        var _this = this;
        this.slideChange$
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["debounceTime"])(500)).subscribe(function (res) {
            _this.slideValue = res;
            _this.productFilter.loanAmount = res;
        });
    };
    LoansFilterComponent.prototype.onRequestLoansFromAllBanks = function () {
        var ref = this.dialog.open(_loan_request_dialog_loan_request_dialog_component__WEBPACK_IMPORTED_MODULE_8__["LoanRequestDialogComponent"], {
    ...
    LoansFilterComponent.ctorParameters = function () { return [
...
module.exports = ":host {\n  display: block;\n}\n\n.sort-field {\n  font-size: 13px;\n}\n\n.cards {\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n}\n\n.card {\n  min-height: 130px;\n  padding: 20px;\n  margin: 8px 0 0;\n  width: 100%;\n  max-width: 350px;\n}\n\n.card .card__header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  border-bottom: 1px solid #dddede;\n  padding-bottom: 10px;\n}\n\n.card .card__header .card__header__bank img {\n  max-width: 90px;\n  max-height: 30px;\n}\n\n.card .card__content .card__content__row {\n  display: flex;\n  justify-content: space-between;\n  border-bottom: 1px solid #dddede;\n  padding: 10px 0;\n}\n\n.card .card__content .card__content__row .card__content__row__left {\n  font-size: 12px;\n  max-width: 200px;\n}\n\n.card .card__content .card__content__row .card__content__row__right {\n  max-width: 175px;\n  font-size: 12px;\n  font-weight: bold;\n}\n\n.card .card__footer {\n  padding-top: 10px;\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n}\n\n.card .card__footer a {\n  width: 45%;\n  font-size: 14px;\n}\n\n.expand {\n  font-size: 12px;\n  display: flex;\n  color: #2980b9;\n  margin-top: 10px;\n  cursor: pointer;\n}\n\n.expand .expand__title {\n  margin-right: 3px;\n  font-family: \"Montserrat-Medium\";\n  font-size: 13px;\n}\n\n.expand .expand__icon {\n  transition: transform 300ms ease-in-out;\n}\n\n.expand.--top .expand__icon {\n  transform: rotateZ(-180deg);\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var LoansCardsComponent = /** @class */ (function () {
    function LoansCardsComponent(loanService) {
        this.loanService = loanService;
        this.sortChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    LoansCardsComponent.prototype.ngOnInit = function () {
    };
    LoansCardsComponent.prototype.onExpandGroup = function (groupId) {
    ...
    LoansCardsComponent.prototype.onSort = function (sortKey) {
        this.sortState = { orderByColumn: sortKey, orderBySort: 'asc' };
        this.sortChange.next(this.sortState);
    };
    LoansCardsComponent.prototype.canAddProductToCompare = function (loanID) {
        return this.loanService.getSavedCompareProductList()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (loans) { return !!loans.find(function (l) { return l.lnID === loanID; }); }));
    };
    LoansCardsComponent.prototype.onAddProductToCompare = function (loan) {
        this.loanService.addProductToCompare(loan);
        // this.changeRef.detectChanges();
    };
    LoansCardsComponent.ctorParameters = function () { return [
        { type: _loans_service__WEBPACK_IMPORTED_MODULE_2__["LoansService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var LoansTableComponent = /** @class */ (function () {
    function LoansTableComponent(route, loanService, changeRef, breakpointObserver, sharedService, dialog, translateService, titleService) {
        this.route = route;
        this.loanService = loanService;
        this.changeRef = changeRef;
        this.breakpointObserver = breakpointObserver;
    ...
    LoansTableComponent.prototype.resize = function () { this.updateForLayoutChange(); };
    LoansTableComponent.prototype.ngOnInit = function () {
        this.listenToRouterParams();
        this.changeRef.detectChanges();
    };
    Object.defineProperty(LoansTableComponent.prototype, "isLGSize", {
        get: function () {
    ...
    Object.defineProperty(LoansTableComponent.prototype, "showDocuments", {
        get: function () {
    ...
    LoansTableComponent.prototype.onExpandGroup = function (groupId) {
        if (this.expandedGroupId === groupId) {
            this.expandedGroupId = undefined;
            return;
        }
    ...
    LoansTableComponent.prototype.ngOnDestroy = function () {
        this._onDestroy$.next();
    };
    LoansTableComponent.prototype.updateForLayoutChange = function () {
        this.changeRef.detectChanges();
    };
    LoansTableComponent.prototype.listenToRouterParams = function () {
        var _this = this;
        this.route.params
            ...
            var defaultFilter = new _models_loan_filter_form__WEBPACK_IMPORTED_MODULE_9__["LoanFilterForm"]();
            var formValue = {
            ...
            _this.getListloanGroupProducts(formValue);
        });
        this.changeRef.detectChanges();
    };
    LoansTableComponent.prototype.getListloanGroupProducts = function (data, scrollIntoView) {
        var _this = this;
        ...
        this.loanService.getListLoanGroupProducts(data)
            ...
            .subscribe(function (res) {
            _this.loanGroupProducts = res;
            _this.filteredGroupProducts = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.loanGroupProducts);
            if (scrollIntoView) {
                Object(src_app_app_utils__WEBPACK_IMPORTED_MODULE_6__["switchToView"])('#products-table-filter');
            }
        });
    };
    LoansTableComponent.prototype.onAddProductToCompare = function (loan) {
        this.loanService.addProductToCompare(loan);
        this.changeRef.detectChanges();
    };
    LoansTableComponent.prototype.canAddProductToCompare = function (loanID) {
        return this.loanService.getSavedCompareProductList()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (loans) { return !!loans.find(function (l) { return l.lnID === loanID; }); }));
    };
    LoansTableComponent.prototype.onSortChange = function (sortChange) {
        this.sortState = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, sortChange);
        this.filteredGroupProducts = this.sharedService.sortTableWithRowGroups(this.sortState, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.loanGroupProducts));
        this.changeRef.detectChanges();
    };
    LoansTableComponent.prototype.applyFilter = function (filterValue) {
        this.filteredGroupProducts = this.sharedService.
            filterTableWithRowGroups(filterValue, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.loanGroupProducts), ['bankName']);
        this.changeRef.detectChanges();
    };
    LoansTableComponent.prototype.openDocumentDialog = function (documentData) {
        var text = documentData[this.translateService.getDefaultLang()];
    ...
    LoansTableComponent.ctorParameters = function () { return [
...
var LoansComponent = /** @class */ (function () {
    function LoansComponent(titleService, tanslateService) {
        this.titleService = titleService;
        this.tanslateService = tanslateService;
        this.titleService.setTitle(this.tanslateService.instant('~loans'));
    }
    LoansComponent.ctorParameters = function () { return [
...
var LoanFilterForm = /** @class */ (function () {
...
//# sourceMappingURL=home-loans-loans-module-es5.js.map