...
var AddOrEditDebitCardComponent = /** @class */ (function () {
    function AddOrEditDebitCardComponent(data, dialogRef, sharedAdminService, productService, adminService, translateService) {
        this.data = data;
    ...
    AddOrEditDebitCardComponent.prototype.ngOnInit = function () {
    ...
    AddOrEditDebitCardComponent.prototype.onUpdate = function () {
        var _this = this;
        if (!this.form.valid) {
            return;
        }
    ...
    AddOrEditDebitCardComponent.prototype.onAdd = function () {
        var _this = this;
        if (!this.form.valid) {
            return;
        }
    ...
    AddOrEditDebitCardComponent.prototype.onAddSuccess = function (res) {
        this.adminService
            .createNotification("[ Debit CARD] " + this.translateService.instant('~addSuccess'), 'OK', 'success');
        this.dialogRef.close(res);
    };
    AddOrEditDebitCardComponent.prototype.onUpdateSuccess = function (res) {
        this.adminService
            .createNotification("[ Debit CARD] " + this.translateService.instant('~updateSuccess'), 'OK', 'success');
        this.dialogRef.close(res);
    };
    AddOrEditDebitCardComponent.ctorParameters = function () { return [
    ...
    return AddOrEditDebitCardComponent;
}());
...
var AdminDebitCardsComponent = /** @class */ (function () {
    function AdminDebitCardsComponent(productService, translateService, dialog, adminService, changeRef) {
        this.productService = productService;
        this.translateService = translateService;
        this.dialog = dialog;
        this.adminService = adminService;
    ...
    AdminDebitCardsComponent.prototype.ngOnInit = function () {
        this.getData();
    };
    AdminDebitCardsComponent.prototype.applyFilter = function (column, filterValue) {
        console.log(column);
    ...
    AdminDebitCardsComponent.prototype.applyMultiLangFilter = function (column, filterValue) {
        this.dataSource.filterPredicate =
    ...
    AdminDebitCardsComponent.prototype.isMultiLang = function (column) {
        if (column === 'editer') {
            return 'editer';
        }
        return (column === 'cardName' || column === 'description' || column === 'descriptionDOC') ? 'multilang' : 'standard';
    };
    AdminDebitCardsComponent.prototype.getData = function () {
        var _this = this;
    ...
    AdminDebitCardsComponent.prototype.getFilterValue = function (column) {
        if (!(this.dataFilterState && this.dataFilterState.column === column)) {
            return;
        }
        return this.dataFilterState.filterValue;
    };
    AdminDebitCardsComponent.prototype.onEdit = function (item) {
        var _this = this;
        var ref = this.dialog.open(_add_or_edit_debit_card_add_or_edit_debit_card_component__WEBPACK_IMPORTED_MODULE_10__["AddOrEditDebitCardComponent"], tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ data: {
                item: item
    ...
    AdminDebitCardsComponent.prototype.onAdd = function () {
        var _this = this;
        var ref = this.dialog.open(_add_or_edit_debit_card_add_or_edit_debit_card_component__WEBPACK_IMPORTED_MODULE_10__["AddOrEditDebitCardComponent"], tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ data: {} }, _admin_panel_utils__WEBPACK_IMPORTED_MODULE_11__["TableDialogConfig"]));
        ref.afterClosed().subscribe(function (res) { return res && _this.getData(); });
    };
    AdminDebitCardsComponent.prototype.onDelete = function (element) {
        var _this = this;
        var ref = this.dialog.open(_shared_components_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_12__["ConfirmDialogComponent"], {
            data: {
        ...
        ref.afterClosed().subscribe(function (res) {
            if (res) {
                _this.productService.crudProduct(_models_crud_command_type_enum__WEBPACK_IMPORTED_MODULE_9__["CrudCommandType"].DELETE, element)
                    ...
                    if (res) {
                        _this.adminService
                            .createNotification("[ DEBIT CARD ] " + _this.translateService.instant('~deleteSuccess'), 'OK', 'success');
                        _this.getData();
                    }
                });
            }
    ...
    AdminDebitCardsComponent.prototype.showAllColumns = function () {
        this.visibleColumns = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.allColumns);
    };
    AdminDebitCardsComponent.prototype.hideAllColumns = function () {
        this.visibleColumns = [];
    };
    AdminDebitCardsComponent.prototype.onToggleColumns = function (columns) {
        this.visibleColumns = columns;
    };
    AdminDebitCardsComponent.ctorParameters = function () { return [
    ...
    return AdminDebitCardsComponent;
}());
...
var AdminDebitCardsModule = /** @class */ (function () {
    function AdminDebitCardsModule() {
    }
...
var AdminDebitCardsRoutingModule = /** @class */ (function () {
    function AdminDebitCardsRoutingModule() {
    }
    ...
    return AdminDebitCardsRoutingModule;
}());
...
var AdminDebitCardsService = /** @class */ (function () {
    function AdminDebitCardsService(http, adminPanelService) {
        this.http = http;
        this.adminPanelService = adminPanelService;
    }
    AdminDebitCardsService.prototype.crudProduct = function (commandType, product) {
        if (product === void 0) { product = {}; }
        if (product && product.cardImage) {
            product.cardImage = product.cardImage.split(',')[1];
        }
        return this.http.post('mybank/crud/cardDebetProduct', tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ adminToken: this.adminPanelService.token, commandType: commandType }, product)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res && res.data; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (er) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null); }));
    };
    AdminDebitCardsService.ctorParameters = function () { return [
...
//# sourceMappingURL=admin-debit-cards-admin-debit-cards-module-es5.js.map